...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	...
	<body>
            ...
            <ul>
				...
				<li><a href="/pcsoftapp/complaint" title=""><img src="${resource(dir: 'images', file: 'sexy.png')}" alt="Contact Us" width="37" height="37" id="contact" /> Distributor </a>
				<ul>
					<li><a href="/pcsoftapp/response">Send Schedule</a></li>
					<li><a href="/pcsoftapp/feedback/list">View Feedbacks</a></li>
                </ul>
				</li>
				<li><img src="${resource(dir: 'images', file: 'deletered.png')}" alt="Home" width="41" height="37" id="home" /><g:link controller="logout">Log out</g:link></li>
            </ul>
